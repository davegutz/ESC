...
static const double DCPDL = -2.551;                // TODO dCpdLambda, dimensionless.  Cp is power coefficient and Lambda is speed tip ratio
static const double LAMBDA = 2.91;                 // TODO Turbine tip speed ratio to air velocity, dimensionless
static const double DELTAV = 7.5;                  // TODO Air velocity turbine first moves, m/s
